...
class _ProfessionalRegistrationScreenState extends State<ProfessionalRegistrationScreen> 
          ...
          children: [
            ...
            ListTile(
              leading: Container(
                ...
                child: const Icon(Icons.photo_library, color: AppColors.mediumGreen),
              ),
      ...
      child: Column(
        children: [
          AnimatedContainer(
            ...
            height: 32,
            decoration: BoxDecoration(
              color: isActive || isCompleted ? AppColors.mediumGreen : Colors.grey[300],
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 11,
              color: isActive ? AppColors.mediumGreen : Colors.grey[600],
  ...
  Widget _buildStepConnector(int step) {
    return Container(
      height: 2,
      width: 24,
      color: step < _currentStep ? AppColors.mediumGreen : Colors.grey[300],
