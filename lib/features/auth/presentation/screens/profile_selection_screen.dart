          ...
          SafeArea(
            child: Column(
              children: [
                ...
                // Content with scroll to prevent overflow
                Expanded(
  ...
  Widget _buildTitleSection(bool isDarkMode) {
    return Column(
      children: [
        ...
        // Subtitle - CORRIGIDO: Simplify ao invés de CareConnect
        FadeTransition(
      ...
      children: [
        ...
        ScaleTransition(
          ...
          child: _buildProfileCard(
            ...
            subtitle: 'Encontre profissionais de limpeza qualificados',
        ...
        ScaleTransition(
          ...
          child: _buildProfileCard(
            ...
            subtitle: 'Ofereça seus serviços de limpeza e organização',
...
class BackgroundPatternPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 5; i++) {
      ...
      paint.color = AppColors.primaryGreen.withOpacity(opacity);
